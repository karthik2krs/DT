...
a.extend=h.extend}
return a}});getHeaders=function(dt){var thRows=dt.nTHead.rows;var numRows=thRows.length;var matrix=[];for(var rowIdx=0;rowIdx<numRows;rowIdx++){var $row=$(thRows[rowIdx]);var $ths=$row.children("th");for(var colIdx=0;colIdx<$ths.length;colIdx++){var $th=$($ths.get(colIdx));var colspan=$th.attr("colspan")||1;var rowspan=$th.attr("rowspan")||1;var colCount=0;if(matrix[rowIdx]===undefined){matrix[rowIdx]=[]}
